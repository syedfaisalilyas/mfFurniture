...
export async function downloadReceipt(order) {
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .tagline { font-size: 14px; opacity: 0.7; margin: 4px 0 0; }
        .receipt-title { font-size: 14px; opacity: 0.9; margin-top: 20px; }
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="info-row">
          ...
          <span class="info-value" style="max-width: 60%; text-align: right;">${order.shippingAddress}</span>
        </div>
      </div>
  ...
  await Sharing.shareAsync(uri, {
    ...
    dialogTitle: `Receipt - Order #${order.id}`,
    UTI: 'com.adobe.pdf',
  });
}
